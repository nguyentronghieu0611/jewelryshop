$(function() {
    ...
    $(".btnRun").click(function() {
        ...
        $.ajax({
            url: "/IOC_CLIENT/service/runJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
    ...
    $(".btnPause").click(function() {
    	var jobId = $(this).parent().data("id");
        $.ajax({
            url: "/IOC_CLIENT/service/pauseJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
                "jobName": $("#name_"+jobId).text(),
                "jobGroup": $("#group_"+jobId).text()
    ...
    $(".btnResume").click(function() {
    	var jobId = $(this).parent().data("id");
        $.ajax({
            url: "/IOC_CLIENT/service/resumeJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
                "jobName": $("#name_"+jobId).text(),
                "jobGroup": $("#group_"+jobId).text()
    ...
    $(".btnDelete").click(function() {
    	var jobId = $(this).parent().data("id");
        $.ajax({
            url: "/IOC_CLIENT/service/deleteJob?t=" + new Date().getTime(),
            type: "POST",
            data: {
                "jobName": $("#name_"+jobId).text(),
                "jobGroup": $("#group_"+jobId).text()
    ...
    $("#save").click(
	    function() {
	    	$.ajax({
	            url: "/IOC_CLIENT/service/saveOrUpdate?t=" + new Date().getTime(),
	            type: "POST",
